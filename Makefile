...
vasp-fc-to-forces : types_and_constants.o derived_constants.o sgsym.o commod.o
	$(F90) -o $@ types_and_constants.o sgsym.o commod.o $@.f90 $(lapack) 

clean:
	- rm vasp-fc-to-forces *.mod types_and_constants.o derived_constants.o sgsym.o commod.o
